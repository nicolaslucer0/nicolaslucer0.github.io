...
export class TrailMaker extends ExternalInteractorBase {
    ...
    isEnabled(particle) {
        ...
        return ((mouse.clicking && mouse.inside && !!mouse.position && isInArray("trail" /* ClickMode.trail */, events.onClick.mode)) ||
            (mouse.inside && !!mouse.position && isInArray("trail" /* HoverMode.trail */, events.onHover.mode)));
    }
