...
export class PolygonMaskInstance {
    ...
    clickPositionValid(position) {
        ...
        return (options.enable &&
            options.type !== "none" /* PolygonMaskType.none */ &&
            options.type !== "inline" /* PolygonMaskType.inline */ &&
    ...
    particlesInitialization() {
        ...
        if (options.enable &&
            options.type === "inline" /* PolygonMaskType.inline */ &&
            (options.inline.arrangement === "one-per-point" /* PolygonMaskInlineArrangement.onePerPoint */ ||
                options.inline.arrangement === "per-point" /* PolygonMaskInlineArrangement.perPoint */)) {
            this.drawPoints();
            return true;
        }
        return false;
    ...
    resize() {
        ...
        if (!(options.enable && options.type !== "none" /* PolygonMaskType.none */)) {
            return;
        }
    ...
    checkInsidePolygon(position) {
        var _a, _b;
        const container = this._container, options = this.options;
        if (!options.enable || options.type === "none" /* PolygonMaskType.none */ || options.type === "inline" /* PolygonMaskType.inline */) {
            return true;
        }
        ...
        // }
        return options.type === "inside" /* PolygonMaskType.inside */
            ? inside
            : options.type === "outside" /* PolygonMaskType.outside */
                ? !inside
                : false;
    }
    createPath2D() {
    ...
    polygonBounce(particle, _delta, direction) {
        const options = this.options;
        if (!this.raw || !options.enable || direction !== "top" /* OutModeDirection.top */) {
            return false;
        }
        if (options.type === "inside" /* PolygonMaskType.inside */ || options.type === "outside" /* PolygonMaskType.outside */) {
            let closest, dx, dy;
        ...
        else if (options.type === "inline" /* PolygonMaskType.inline */ && particle.initialPosition) {
    ...
    randomPoint() {
        const container = this._container, options = this.options;
        let position;
        if (options.type === "inline" /* PolygonMaskType.inline */) {
            switch (options.inline.arrangement) {
                case "random-point" /* PolygonMaskInlineArrangement.randomPoint */:
                    position = this.getRandomPoint();
                    break;
                case "random-length" /* PolygonMaskInlineArrangement.randomLength */:
                    position = this.getRandomPointByLength();
                    break;
                case "equidistant" /* PolygonMaskInlineArrangement.equidistant */:
                    position = this.getEquidistantPointByIndex(container.particles.count);
                    break;
                case "one-per-point" /* PolygonMaskInlineArrangement.onePerPoint */:
                case "per-point" /* PolygonMaskInlineArrangement.perPoint */:
                default:
