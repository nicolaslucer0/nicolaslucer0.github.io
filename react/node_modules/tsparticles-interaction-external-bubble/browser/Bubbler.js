...
export class Bubbler extends ExternalInteractorBase {
    constructor(container) {
        ...
        this.handleClickMode = (mode) => {
            if (mode !== "bubble" /* ClickMode.bubble */) {
                return;
            }
            if (!container.bubble) {
                container.bubble = {};
    ...
    async interact(delta) {
        ...
        /* on hover event */
        if (hoverEnabled && isInArray("bubble" /* HoverMode.bubble */, hoverMode)) {
            this.hoverBubble(delta);
        }
        else if (clickEnabled && isInArray("bubble" /* ClickMode.bubble */, clickMode)) {
            this.clickBubble(delta);
        }
        else {
            divModeExecute("bubble" /* DivMode.bubble */, divs, (selector, div) => this.singleSelectorHover(delta, selector, div));
        }
    }
    isEnabled(particle) {
        var _a;
    ...
    clickBubble(delta) {
        ...
        for (const particle of query) {
            ...
            const sizeData = {
                ...
                type: "size" /* ProcessBubbleType.size */,
            };
            ...
            const opacityData = {
                ...
                type: "opacity" /* ProcessBubbleType.opacity */,
            };
