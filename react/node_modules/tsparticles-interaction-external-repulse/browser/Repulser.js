...
export class Repulser extends ExternalInteractorBase {
    constructor(container) {
        ...
        this.handleClickMode = (mode) => {
            ...
            if (!repulse || mode !== "repulse" /* ClickMode.repulse */) {
                return;
            }
            if (!container.repulse) {
                container.repulse = { particles: [] };
    ...
    async interact() {
        ...
        if (mouseMoveStatus && hoverEnabled && isInArray("repulse" /* HoverMode.repulse */, hoverMode)) {
            this.hoverRepulse();
        }
        else if (clickEnabled && isInArray("repulse" /* ClickMode.repulse */, clickMode)) {
            this.clickRepulse();
        }
        else {
            divModeExecute("repulse" /* DivMode.repulse */, divs, (selector, div) => this.singleSelectorRepulse(selector, div));
        }
    }
    isEnabled(particle) {
        var _a;
        const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, events = ((_a = particle === null || particle === void 0 ? void 0 : particle.interactivity) !== null && _a !== void 0 ? _a : options.interactivity).events, divs = events.onDiv, divRepulse = isDivModeEnabled("repulse" /* DivMode.repulse */, divs);
        if (!(divRepulse || (events.onHover.enable && mouse.position) || (events.onClick.enable && mouse.clickPosition))) {
            return false;
        }
        const hoverMode = events.onHover.mode, clickMode = events.onClick.mode;
        return isInArray("repulse" /* HoverMode.repulse */, hoverMode) || isInArray("repulse" /* ClickMode.repulse */, clickMode) || divRepulse;
    }
